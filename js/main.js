...
/* harmony import */ var _components_smoothScroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/smoothScroll.js */ "./src/js/components/smoothScroll.js");
...
/* harmony import */ var _components_fslightbox_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/fslightbox.js */ "./src/js/components/fslightbox.js");
/* harmony import */ var _components_openVideo_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/openVideo.js */ "./src/js/components/openVideo.js");
/* harmony import */ var _components_animation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/animation.js */ "./src/js/components/animation.js");
...
(0,_components_smoothScroll_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_components_burger_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_components_fslightbox_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_components_openVideo_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_components_animation_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
  ...
  if (animItems.length > 0) {
    ...
    function animOnScroll(params) {
      for (let index = 0; index < animItems.length; index++) {
        ...
        if (pageYOffset > animItemOffset - aminItemPoint && pageYOffset < animItemOffset + animItemHeight) {
...
const burger = () => {
  ...
  const menu = document.querySelector(".header-tablet__bottom");
  console.log(menu);
  burger.addEventListener("click", e => {
    console.log("click");
    burger.classList.toggle("burger--active");
    menu.classList.toggle("header-tablet__bottom--active");
  });
  console.log(burger);
};
...
const fslightbox = () => {
  !function (e, t) {
    if ("object" == typeof exports && "object" == "object") module.exports = t();else if ("function" == typeof define && __webpack_require__.amdO) define([], t);else {
      var n = t();
    ...
    return function (e) {
      ...
      function ee(e) {
        ...
        n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
          ...
          var o = function () {
            document.body.offsetHeight > innerHeight && (document.body.style.marginRight = 0 + "px");
          };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fslightbox);

/***/ }),

/***/ "./src/js/components/openVideo.js":
/*!****************************************!*\
  !*** ./src/js/components/openVideo.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
const openVideo = () => {
  document.querySelector(".about__right-play").addEventListener("click", () => {
    fsLightboxInstances["video"].open(0);
  });
  document.querySelector(".item-play--1").addEventListener("click", () => {
    fsLightboxInstances["video2"].open(0);
  });
  document.querySelector(".item-play--3").addEventListener("click", () => {
    fsLightboxInstances["video3"].open(0);
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (openVideo);
...
/* harmony export */ });
const smoothScroll = () => {
  const menuBtnAll = document.querySelectorAll(".nav__link");
  const menuBtnAllTablet = document.querySelectorAll(".header-tablet__nav-link");
  const btnScrollTop = document.querySelector(".btn-top");
  const menu = document.querySelector(".header-tablet__bottom");
  const burger = document.querySelector(".burger");
  const heroBtnScroll = document.querySelector(".hero__btn");
  btnScrollTop.style.display = "none";
  heroBtnScroll.addEventListener("click", event => {
    event.preventDefault();
    const section = document.querySelector(heroBtnScroll.getAttribute("href"));
